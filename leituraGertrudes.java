...
de acordo com o número de páginas de um livro, quanto tempo ela levaria 
para ler lendo apenas 3 páginas por dia. Como você está aprendendo Java, 
...
public class leituraGertrudes {
    public static void main(String[] args) {
        ...
        int paginasLidas = 3;
            ...
            System.out.print(paginas/paginasLidas);
